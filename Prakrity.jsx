...
import AOS from "aos";
import image from "../assets/Images/img/banner/healthcare-6.jpg";
import fluid from "../assets/Images/img/banner/healthcare-8.jpg";
    ...
    <>
      <main className="main">
        <div className="page-title light-background">
          <div className="container d-lg-flex justify-content-between align-items-start">
            ...
            <nav className="breadcrumbs">
              <ol>
                ...
                <li className="current"> PRAKRITI ASSESSMENT</li>
              </ol>
            </nav>
          </div>
        </div>
        ...
        <section id="about-2" className="about-2 section">
          <div className="container" data-aos="" data-aos-delay={100}>
            <div className="row">
              <div className="col-lg-12">
               ...
               YOUR PRAKRITI ASSESSMENT
                ...
                <p className="about-description">
                  This concept is beautifully aligned with the Prakriti quiz, an
                  ancient Ayurvedic tool that identifies your unique mind-body
                  constitution. By understanding your Prakriti—whether it's
                  Vata, Pitta, or Kapha—you gain insights into your natural
                  tendencies, strengths, and areas needing balance. The quiz
                  helps you recognize imbalances in your life and offers
                  personalized guidance to harmonize your lifestyle, diet, and
                  mental habits. This self-awareness fosters holistic
                  well-being, promoting physical vitality, emotional stability,
                ...
                <p className="about-description">
                  ...
                  constitution. By understanding your Prakriti—whether it's
                  Vata, Pitta, or Kapha—you gain insights into your natural
                  tendencies, strengths, and areas needing balance.
                </p>
              </div>
              <div className="col-lg-12">
                    ...
                    <>
                      <div className="row">
                        <div className="form-header text-center">
                          <h2>Take Our PRAKRITI ASSESSMENT</h2>
                          <p>Discover your Parakriti - Mind Body Type</p>
                        </div>
              ...
              <div className="col-lg-12">
                <h2 className="about-title">What is Your Prakriti?</h2>
                <p className="about-description">
                  In Ayurveda, Prakriti refers to your natural constitution or
                  the unique makeup you're born with, determined at conception.
                  It's a mix of three energies—vata, pitta, and kapha—which
                  shape your body, mind, and personality. Knowing your Prakriti
                  helps you understand how your body works and how to keep it
                  balanced for better health. When you take a Prakriti
                  assessment, you'll get a personalized breakdown of your
                  natural state, showing how it affects things like digestion,
                  immunity, emotions, and even your personality. With this
                  understanding, you'll also receive tailored advice on herbs,
                  diet, and lifestyle changes to keep your body and mind in
                  balance. By learning your Prakriti, you can make better
                  choices that suit your true self, helping you stay healthy and
                  full of energy for the long term.
                </p>
              </div>
              <div
                className="col-lg-12"
              ...
              <div className="col-lg-6">
                <h2 className="about-title">
                  Why Is This Prakriti Assessment Important?
                </h2>
                <p className="about-description">
                 By learning your Prakriti, you can make better
                  choices that suit your true self, helping you stay healthy and
                  full of energy for the long term.
                  <br />
                </p>
                <ul>
                  <li>
                    <strong>Identify imbalances</strong> in your Doshas that
                    could weaken your immune system.
                  </li>
                  <li>
                    <strong>Discover lifestyle changes </strong> and dietary
                    recommendations suited to your unique body constitution{" "}
                    <strong>(Prakriti).</strong>
                  </li>
                  <li>
                    <strong>Prevent illness</strong> by taking proactive
                    measures to strengthen your immunity.
                  </li>
                  <li>
                    <strong>Enhance overall vitality </strong> by focusing on
              ...
              In Ayurveda, Prakriti refers to your natural constitution or
                  ...
                  assessment, you'll get a personalized breakdown of your
                  natural state, showing how it affects things like digestion,
                  immunity, emotions, and even your personality. 
                </p>
              </div>
              <div className="col-lg-6">
                <h2 className="about-title">
                ...
                <p className="about-description">
                  This Prakriti assessment is designed based on Ayurvedic
                  principles and will cover:
                  <br />
                </p>
                <ul>
                  <li>
                    <strong>Your body type (Dosha) </strong> and how it
                    influences your immunity.
                  </li>
                  <li>
                    <strong>Lifestyle and habits </strong> that may affect your
                    immune system.
                  </li>
                  <li>
                    <strong>Mental and emotional well-being</strong> as stress
                    can deeply impact immunity.
                  </li>
                  <li>
                    <strong>Dietary patterns </strong>that could either enhance
                    or suppress your body’s natural defenses.
                  </li>
                  <li>
                    <strong>Practical tips and Ayurvedic remedies </strong>to
